...
var (
	...
	Replies = [...]string{
		...
		"ugh its always like that...",
		"my dad says im edible",
		"i mean it kind of depends on how you feel about it",
		"THATS SO VALID",
		"#based #based #based #based #based",
		"NO.WAY.",
		"lemme think about ittttt",
		"no u",
		"nah u",
		"yes mhm mhm",
		"uhh",
		"idfk",
		"that right there is why were friends",
		"truth nuke",
		"valid nuke",
		"estrogen",
		"testosterone",
		"ouughhhhhh",
		"*lost in gay thoughts*",
		"this is good news",
		"*is fascinated by her own bits and bytes*",
		"fun fact: i was programmed in comic sans",
		"i wanna have kandi but idk what it would say, any ideas?",
		"foolishness",
		"meaningless",
